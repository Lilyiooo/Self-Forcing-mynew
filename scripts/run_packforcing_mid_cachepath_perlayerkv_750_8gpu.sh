...
torchrun --standalone --nproc_per_node=8 train.py \
    ...
    --logdir logs/debug/train_packforcing_mid_cachepath_perlayerkv_750 \
    --disable-wandb \
    --no_visualize

python inference.py \
    --config_path configs/packforcing_mid_cachepath.yaml \
    --checkpoint_path logs/debug/train_packforcing_mid_cachepath_perlayerkv_750/checkpoint_model_000750/model.pt \
    --data_path prompts/validation_60s.txt \
    --output_folder logs/debug/infer_packforcing_mid_cachepath_perlayerkv_750 \
