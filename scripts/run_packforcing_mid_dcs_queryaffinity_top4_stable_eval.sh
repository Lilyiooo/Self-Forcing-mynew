...
RESULT_ROOT="/inspire/qb-ilm/project/exploration-topic/wangqiqi-CZXS25210124/Self-Forcing-mynew_result/dcs_queryaffinity_top4_stable"
CONFIG_PATH="configs/packforcing_mid_dcs_queryaffinity_top4_stable_eval.yaml"
