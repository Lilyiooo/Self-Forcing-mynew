...
RESULT_ROOT="/inspire/qb-ilm/project/video-generation/public/wangqiqi/Self-Forcing-packforcing/dcs_topk_kvdistill500_perlayerkv_2500"
TRAIN_LOGDIR="${RESULT_ROOT}/train"
CONFIG_PATH="configs/packforcing_mid_dcs_topk_kvdistill500_2500.yaml"
