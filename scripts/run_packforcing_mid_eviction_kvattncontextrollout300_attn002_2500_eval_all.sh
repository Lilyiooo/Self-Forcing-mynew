...
RESULT_ROOT="/inspire/qb-ilm/project/exploration-topic/wangqiqi-CZXS25210124/Self-Forcing-mynew_result/mideviction_kvattncontextrollout300_attn002_2500"
TRAIN_LOGDIR="${RESULT_ROOT}/train"
CONFIG_PATH="configs/packforcing_mid_eviction_kvattncontextrollout300_attn002_2500.yaml"
