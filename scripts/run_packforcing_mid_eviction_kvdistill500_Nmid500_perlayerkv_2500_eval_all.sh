...
RESULT_ROOT="/inspire/qb-ilm/project/video-generation/public/wangqiqi/Self-Forcing-packforcing/mideviction_kvdistill500_Nmid500_perlayerkv_2500"
TRAIN_LOGDIR="${RESULT_ROOT}/train"
CONFIG_PATH="configs/packforcing_mid_eviction_kvdistill500_Nmid500_2500.yaml"
